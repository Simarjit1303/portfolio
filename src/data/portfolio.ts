...
export const projects = [
  ...
  },
  {
    ...
    type: "Data Analysis",
    year: "2026",
    techs: ["Python", "Pandas", "SciPy", "Plotly", "SQL", "Seaborn"],
    desc: "EDA and hypothesis testing on a 4-table e-commerce dataset (10K customers, 45K transactions, 70K sessions) — 10 statistical tests (t-test, chi-squared, Pearson r), Cohen's d effect sizes, and business insights on discount impact, acquisition channels, and revenue trends.",
    color: "#00FF88",
    github: "https://github.com/Simarjit1303/Projects/tree/main/E-Commerce-Customer-Behaviour-Analysis",
  },
  {
    num: "03",
    ...
    year: "2026",
    techs: ["Python", "TF-IDF", "scikit-learn", "TensorFlow", "NLP"],
    desc: "Three-model NLP comparison on WELFake — 72,134 news articles across 4 benchmark sources. TF-IDF feature extraction with Logistic Regression (96.22%), Random Forest (95.09%), and ANN (96.12%). Live prediction demo flags fabricated content at 99.97% confidence.",
    color: "#FF6B6B",
    github: "https://github.com/Simarjit1303/Projects/blob/main/Machine%20Learning/Fake-news-detection-welfake/Fake_News_Detection.ipynb",
  },
  {
    num: "04",
